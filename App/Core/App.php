    ...
    private function prepereURL()
    {
        ...
        if (!empty($url)){
            ...
            // Check if anything is present after the action
            if(isset($url[3])) {
                // Handle the case where something is present after the action (e.g., ID)
                // You can display an error message, redirect the user, or handle it based on your application logic
                echo "Error: Unexpected parameter after action.";
